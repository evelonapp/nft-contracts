    ...
    AccessControl
{
    ...
    // function batchMint(address to, uint256 numberOfNFT)
    //     public
    //     onlyRole(MINTER_ROLE)
    // {
    //     for (uint256 i; i < numberOfNFT; i++) {
    //         safeMint(to);
    //     }
    // }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Chepheus_Astro.ownerOf(tokenId);
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        owner = Chepheus_Astro.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            Chepheus_Astro.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Chepheus_Astro.ownerOf(tokenId), to, tokenId);
    }
